  ...
  return (
    <div className="rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 p-6 text-white shadow-lg">
      ...
      <a
        ...
        className="group inline-flex items-center justify-center w-full gap-2 px-6 py-3 rounded-full bg-white text-blue-600 font-bold hover:bg-blue-50 hover:scale-105 transition-all duration-300 shadow-lg"
      >
      ...
      {/* Trust Badge */}
      <div className="mt-4 pt-4 border-t border-white/20 flex items-center justify-center gap-2 text-xs text-blue-100">
