/**
 * [Component] WordPress & SEO FAQ Section
 * [Design] Accordion with Premium Red Theme
 */
...
const faqs: FAQItem[] = [
  ...
  {
    question: "SEO 최적화는 어떻게 진행되나요?",
    answer: "기술적 SEO(사이트 구조, 속도, 모바일 최적화), 온페이지 SEO(메타태그, 헤딩 구조, 콘텐츠 최적화), Schema Markup(구조화된 데이터) 구현을 진행합니다. Google Search Console 연동, XML 사이트맵 제출, 내부링크 최적화 등을 통해 검색 엔진이 사이트를 효율적으로 크롤링하도록 설정합니다."
  },
  {
  ...
  {
    question: "호스팅과 도메인은 어떻게 준비하나요?",
    answer: "호스팅과 도메인은 고객님 명의로 직접 등록하시는 것을 권장하며, 추천 업체와 가입 방법을 안내해드립니다. 원하실 경우 대행 등록도 가능하며, 이 경우에도 소유권은 고객님께 귀속됩니다. 초기 설정과 워드프레스 설치는 저희가 진행합니다."
  },
  {
  ...
  {
    question: "기존 사이트를 워드프레스로 이전할 수 있나요?",
    answer: "네, 가능합니다. 기존 사이트의 콘텐츠, 이미지, 구조를 분석하여 워드프레스로 안전하게 이전합니다. 이전 과정에서 SEO 가치를 유지하기 위해 URL 리다이렉션 설정, 메타데이터 보존 등의 작업을 진행하며, 검색 순위 하락을 최소화합니다."
  },
  {
    ...
    <section className="relative py-20 md:py-24">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-red-200 text-red-600 text-sm font-semibold mb-6">
