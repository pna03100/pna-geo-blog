      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-8">
          <div>
            ...
            <FadeIn delay={0.1}>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4 tracking-tight !leading-[1.3]">
                검증된 전문성과
                <br />
          ...
          <FadeIn delay={0.2}>
            <div className="rounded-2xl bg-white border border-slate-200 shadow-sm p-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-slate-900">안태민 CEO</h3>
                  <p className="text-slate-500 font-medium">Founder & Chief Executive Officer</p>
                </div>
              </div>
            ...
            {expertise.map((item, index) => {
              ...
              return (
                <FadeIn key={item.title} delay={0.3 + index * 0.1}>
                  <div className="rounded-2xl bg-white border border-slate-200 shadow-sm p-6 hover:border-[#2563EB] hover:shadow-md transition-all">
              ...
              <div className="grid grid-cols-3 gap-6">
                {partners.map((partner, index) => (
                  <motion.div
                    ...
                    className="flex flex-col items-center justify-center p-6 rounded-xl bg-slate-50 hover:bg-blue-50 transition-all duration-300"
                  >
